            ...
            <div class="col-lg-12 side-left">
              <div class="card mb-6">
                <div class="card-body avatar">
                 ...
                 <img src="{{ asset('images/teachers/' . $teacher->teachers_image) }}" width="100" 
     height="120" />
                  <p class="name">{{ $teacher->teachers_name }}</p>
                  <p class="designation">@if($teacher->teachers_department==1)
                          ...
                          @endif</p>
                  <a class="email" href="#">{{ $teacher->teachers_email }}</a>
                  <a class="number" href="#">{{ $teacher->teachers_phone }}</a>
                </div>
              </div>
              <div class="card mb-6">
                <div class="card-body overview">
                  ...
                  <div class="info-links">
                    <a class="website" href="https://www.bootstrapdash.com/">
                      ...
                      <span style="font-family: vermade; font-size: 15px;">{{ $student->student_fathername}}</span>
                    </a>
                    <a class="website" href="https://www.bootstrapdash.com/">
                      <i class="icon-globe icon">Mother's Name</i>
                      <span style="font-family: vermade; font-size: 15px;">{{ $student->student_mothername}}</span>
                    </a><a class="website" href="https://www.bootstrapdash.com/">
                      <i class="icon-globe icon">Student Roll</i>
                      <span style="font-family: vermade; font-size: 15px;">{{ $student->student_roll}}</span>
                    </a><a class="website" href="https://www.bootstrapdash.com/">
                      <i class="icon-globe icon">Student Address</i>
                      <span style="font-family: vermade; font-size: 15px;">{{ $student->student_address}}</span>
                    </a>
