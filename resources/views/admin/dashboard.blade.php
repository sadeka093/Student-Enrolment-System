...
<div class="col-sm-6 col-md-3 grid-margin">
  <div class="card">
    <div class="card-body">
      ...
      <p style="font-family:cursive; font-size:30px; font-weight: bold;text-align: center;">Monthly:2500tk</p>
    </div>
    <div class="dashboard-chart-card-container">
                ...
                <div class="col-12 grid-margin d-flex align-items-stretch">
                  <div class="row">
                    ...
                    <div class="col-12 col-sm-6 col-md-12">
                      <div class="social-panel bg-linkedin"><i class="mdi mdi-linkedin"></i><p class="mb-0">ECE</p></div>
                    </div>
                  </div>
                </div>
